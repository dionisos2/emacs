...
(defconst behave-font-lock-keywords
  (list
   '("\\(Add\\|Given\\|When\\|Scenario\\|Then\\|Feature\\)" . font-lock-builtin-face)))

(defun behave-indent-line ()
  "Indent current line as behave code."
  (interactive)
  (cond
   ((string-match "^[^w]*\\(When\\|Add\\|Given\\|Then\\)" (thing-at-point 'line)) (indent-line-to 4))
   ((string-match "^[^w]*Scenario" (thing-at-point 'line)) (indent-line-to 2))
   (t (indent-line-to 0)))
)
